...
SOURCES = [
    ...
    Source(
        ...
        files=dict(
            ...
            idt_xgen_exome_research_panel_v2_target_regions_bed='xgen_exome_research_panel_v2_targets_hg38.bed',
            idt_xgen_exome_research_panel_v2_target_regions_interval_list='xgen_exome_research_panel_v2_targets_hg38.interval_list',
            idt_xgen_exome_research_panel_v2_probes_bed='xgen_exome_research_panel_v2_probes_hg38.bed',
            idt_xgen_exome_research_panel_v2_probes_interval_list='xgen_exome_research_panel_v2_probes_hg38.interval_list',
            idt_xgen_exome_research_panel_v1_target_regions_bed='xgen_exome_research_panel_targets_hg38.bed',
            idt_xgen_exome_research_panel_v1_target_regions_interval_list='xgen_exome_research_panel_targets_hg38.interval_list',
            idt_xgen_exome_research_panel_v1_probes_bed='xgen_exome_research_panel_probes_hg38.bed',
            idt_xgen_exome_research_panel_v1_probes_interval_list='xgen_exome_research_panel_probes_hg38.interval_list',
            ),
    ),
]
